...
class QuestionIndexViewTest(TestCase):
    ...
    def test_pass_question(self):
        """
        Question with a pub_date in the pass are published on the index page.
        :return:
        """
    ...
    def test_future_queston(self):
        """
        Question with a pub_date in the future are't published on the index page.
        :return:
        """
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both pass and future questions exist,only past question are displayed.
        :return:
        """
        create_question(question_text='Past question.', days=-30)
        create_question(question_text='Future question.', days=30)
